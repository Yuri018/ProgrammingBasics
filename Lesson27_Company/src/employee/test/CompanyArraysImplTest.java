...
class CompanyArraysImplTest {
    ...
    void addEmployee() {
        ...
        Employee employee = new SalesManager(5000, "Rabindranat", "Anand", 80, 30000, 0.1);
        assertTrue(company.addEmployee(employee));
        assertEquals(5, company.quantity());
        employee = new SalesManager(6000, "Rabindranat", "Anand", 80, 30000, 0.1);
